...
function updatePositions() {
  ...
  var phase = [Math.sin((scroll / 1250) + (0 % 5)),
              Math.sin((scroll / 1250) + (1 % 5)),
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    items[i].style.transform = "translateX(" + val + ")";
...
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  var cachedMoving = document.getElementById('movingPizzas1');

  for (var i = 0; i < 32; i++) {
  // we create 32 pizzas since more won't fit on the screen anyway
